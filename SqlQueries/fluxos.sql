...
SELECT DISTINCT 
    ...
    DATE_FORMAT(vital.data_coleta, '%d-%m-%Y %H:%i:%s') AS data, 
    idade.age,
    ...
    FROM 
        ...
        WHERE 
            ...
            AND vital.symptoms_question IN (
                ...
                'Qual é o seu principal sintoma? Aqui vai uma lista dos mais comuns',
                'Selecione abaixo a sua necessidade para podermos te auxiliar:'
                )
