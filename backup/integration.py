...
def main():
  ...
  try:
    ...
    print(dados)
    #------Acima está o código para LER a planilha do Google Sheets --------------


    #Código para atualizar uma célula    -----------------------------------------------------------------------------------
    print("\n")
    #print("\n")
    ...
    #                               range="A13", valueInputOption = "USER_ENTERED", body={'values': inputValues}).execute())
    #-----------------------------------------------------------------------------------------------------------------------
    inputValues = [
      [cpf, cor_alerta, data]        
    ]
    ...
    result = (sheet.values().append(spreadsheetId=SAMPLE_SPREADSHEET_ID,
                                                    range=SAMPLE_RANGE_NAME, valueInputOption="USER_ENTERED", body={'values': inputValues}).execute())
